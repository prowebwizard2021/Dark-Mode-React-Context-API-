...
function App() {
  ...
  useEffect(() => {
    //If darkmode, add 'dark-mode' class into root element.
    if(isDarkMode){
  ...
  return (
    // We can use this context for other child components in bigger application.
        ...
        <div className="level">
          ...
          <button className="app__dark-mode-btn icon level-right" onClick={toggleDarkMode}>
            <FontAwesomeIcon 
              ...
              color={isDarkMode ? "#FFA500" : "#000000"}
            />
          </button>
